...
async function sendEmail({
  ...
  const info = await transporter.sendMail({
    ...
    // Email will go to:
    // 1. User's email
    // 2. Manorama Charitable Trust email
    to: [to, "manoramacharitabletrust@gmail.com"],
  ...
  console.log(
    "📧 To:",
    [to, "manoramacharitabletrust@gmail.com"].join(", ")
  );
  ...
  return sendEmail({
    ...
    html: `
      ...
      ">
        ...
        <p>
          Your Nodemailer email system is working successfully.
        </p>
